    ...
    .service('InfoService', function ($q, dataService) {
        ...
        */
        this.PostContactForm = function (name, email, enquiry) {
         ...
         /**
        * @ngdoc function
        * @name info.module.InfoService#GetRewardPointsOfUser
        * @methodOf info.module.InfoService
        * @kind function
        * 
        * @description
        ...
        */
        this.GetRewardPointsOfUser = function () {
            return dataService.apiSecuredPost('/reward/available').then(function (data) {
                if (data.error) {
