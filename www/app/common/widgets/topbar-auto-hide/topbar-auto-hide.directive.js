	...
	/**
	* @ngdoc directive
	* @name starter.directive:autoHide
	* @description
	* Auto hides top bar and tabs when scrolling down. Allows more screen space for user
	*/
    angular.module('starter')
      .directive('autoHide', function ($document, $timeout, $rootScope, $ionicScrollDelegate) {
              ...
              link: function ($scope, $element, $attr) {
                  ...
                  function translateHeaders(y, duration) {
                      ...
                      if (activeHeader) {
                          ...
                          if (window.StatusBar) {
                              if (statusBarVisible && fadeAmt < 0.8) {
                                  statusBarVisible = false;
                                  statusBarChanged = true;
                              }

                              if (!statusBarVisible && fadeAmt == 1) {
                                  statusBarVisible = true;
                                  statusBarChanged = true;
                              }

                              if (statusBarChanged) if (statusBarVisible) {
