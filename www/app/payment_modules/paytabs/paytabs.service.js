(function () {
    ...
    angular
        ...
        .service('PaymentPaytabsService', function ($http, $q, $ionicLoading, dataService, BASE_URL, BASE_API_URL) {
            ...
            this.OpenPaymetWindow = function (id) {
                ...
                if (cordova && cordova.InAppBrowser) {
                    ...
                    var inappbrowser = cordova.InAppBrowser.open(BASE_API_URL + "/payment_handlers/paytabs/paytabs/send", '_blank', 'hidden=yes');
