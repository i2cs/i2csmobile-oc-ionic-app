(function () {
    ...
    angular
        ...
        .service('PaymentPPStandardService', function ($http, $q, $ionicLoading, dataService, BASE_URL, BASE_API_URL) {
            ...
            this.OpenPaymetWindow = function (id) {
                ...
                if (cordova && cordova.InAppBrowser) {
                    ...
                    var inappbrowser = cordova.InAppBrowser.open(BASE_API_URL + "/payment_handlers/paypal_standard/pp_standard", '_blank', 'hidden=yes');
