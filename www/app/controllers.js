...
*/
angular.module('starter')
    .controller('AppCtrl', function ($scope, $rootScope, locale, $location, $ionicModal, $ionicLoading, $ionicPopup, $localStorage, $state, $timeout, appService, CartService, FORGOT_LINK, EMAIL, PHONE, WELCOME_SLIDES, MENU_LAYOUT) {
        $scope.user = {};
        $scope.page = {};
        ...
        alert = function (log) {
            $ionicPopup.alert({
                title: locale.getString('common.information_popup'),
                template: log
            });
        }
