...
angular
    ...
    .service('CartService', function ($q, dataService) {
        ...
        this.GetShippingMethods = function () {
            return dataService.apiSecuredPost('/shipping/methods').then(function (data) {
                ...
                angular.forEach(data.shipping_methods, function (value, key) {
                    ...
                    angular.forEach(value.quote, function (v, k) {
                        value = v;
                        value.method = k;
                        value.main_title = v.title;
                        array.push(value);
                    });
                });
        ...
        */
        ...
        /**
        * @ngdoc function
        * @name shop.module.CartService#ApplyRewards
        * @methodOf cart.module.CartService
        * @kind function
        * 
        * @description
        * Apply rewards to the shopping cart
        * 
        * @param {string} rewards Rewards points
        * 
        * @returns {promise} Returns a promise of the update response
        */
        this.ApplyRewards = function (reward) {
            return dataService.apiSecuredPost('/reward', { reward: reward }).then(function (data) {
                if (data.error) {
                    return $q.reject(data.error);
                }
        ...
        /**
        * @ngdoc function
        * @name shop.module.CartService#GetAvailableRewards
        * @methodOf cart.module.CartService
        * @kind function
        * 
        * @description
        * Gets available rewards points of the logged in user
        * 
        * @returns {promise} Returns a promise of the update response
        */
        this.GetAvailableRewards = function () {
            return dataService.apiSecuredPost('/reward/maximum').then(function (data) {
                if (data.error) {
                    return $q.reject(data.error);
                }
